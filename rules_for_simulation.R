...
# Rule 3: The prevalence of U2, & U4 are constant over time      #
...
#         is 1 - P4 for D.                                       #
# Rule 6: The preevalence eof U1 decreases over time             #
# Rule 7: The prevalence of U3 increases over time               #
...
for(i in 0:9){
  u3[i + 1] <- exp_fun(0.04, 0.285, i)
}

rules <- tibble(time = 1:10, 
                u1 = 0.25, 
                u2 = 0.05, 
                RR_D_C = (u1 + u2) / u2,
                u3 = u3, 
